...
class RFSOC:
    ...
    def config_hardware(self) -> bool:
        ...
        try:
            ...
            print(self.eth.destmac_a)
            data["destmac_a_msb"] = self.eth.destmac_a[:4]
            data["destmac_a_lsb"] = self.eth.destmac_a[4:]
            data["destmac_b_msb"] = self.eth.destmac_b[:4]
            data["destmac_b_lsb"] = self.eth.destmac_b[4:]
